...
public class Main {
    ...
    private List<GoodsDetail> goodsDetailList = null;
...
//       main.test_trade_pay(tradeService,map);
...
//                .setExceptionInfoList(exceptionInfoList) // 填写异常信息，如果有的话
    ...
    public String trade_pay(Map<?, ?> map){
    	this.totalMoney = map.get("totalMoney").toString();
    	this.aliPay = (String)map.get("aliPay");
    	this.goodsDetailList = (List<GoodsDetail>) map.get("goodsDetailList");
    	this.outTradeNo = (String) map.get("outTradeNo");
    	return this.test_trade_pay(tradeService);
    }
    // 测试当面付2.0支付
...
//        String outTradeNo = "tradepay" + System.currentTimeMillis() + (long)(Math.random() * 10000000L);
        ...
        String subject = "跨客城实体店";

        // (必填) 订单总金额，单位为元，不能超过1亿元
        // 如果同时传入了【打折金额】,【不可打折金额】,【订单总金额】三者,则必须满足如下条件:【订单总金额】=【打折金额】+【不可打折金额】
        String totalAmount = this.totalMoney;

        // (必填) 付款条码，用户支付宝钱包手机app点击“付款”产生的付款条码
        String authCode = this.aliPay; // 条码示例，286648048691290423
...
//        String discountableAmount = "1.00"; //
        ...
        String storeId = PropertiesUtil.getStoreId();
    ...
    public void test_trade_query() {
        ...
        String outTradeNo = "tradeprecreate14657206302881642729";
