...
public class AliGoods extends Thread implements Printable{  
     //O2OMainMenu mm = null;
...
//      }
        ...
        String lsh = PropertiesUtil.getPosNum()+0+0+count2;
        ...
        g2d.drawString(international.getInternational("storeName") +new PropertiesUtil().getStoreName(),0+Prient.transX,70);
        g2d.drawString(international.getInternational("terminalNumber")+posNumString,0+Prient.transX, 80);
        g2d.drawString("流水号:"+lsh,0+Prient.transX,90);
        g2d.drawString(international.getInternational("date")+aString, 0+Prient.transX, 100);
        ...
        g2d.setFont(new Font("Default", Font.PLAIN, 8)); 
        g2d.drawString(international.getInternational("goodsName"), 0+Prient.transX, 160);
        g2d.drawString(international.getInternational("number")+"*"+international.getInternational("unitPirce"), 30+Prient.transX, 160);
        g2d.drawString(international.getInternational("tax"), 70+Prient.transX, 160);
       // g2d.drawString("单价", 55, 80);
        g2d.drawString(international.getInternational("money"), 95+Prient.transX, 160);
...
//           goodsName1 = goodsNames.substring(17,goodsLength);
        ...
        g2d.drawString("合计数量:" + totalNumber, 0+Prient.transX, 220+i*30);  
        g2d.drawString("支付宝支付:" + totalMoney, 0+Prient.transX, 230+i*30);
        ...
        g2d.drawString(international.getInternational("welcome"), 0+Prient.transX, 260+i*30);
