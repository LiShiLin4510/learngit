...
//	}
	 ...
	 *            PARAM_BAUD_RATE_STR :串行口波特率，默认：2400 PARAM_DISPLAY_RATE_STR
	 *            :串行口波特率需要与顾客显示屏的波特设置对应，默认：0。
	 *            （如一些顾显波特率为“2400”对应设置位为“0”，“4800”对应设置位为
	 *            “1”，“9600”对应设置位为“2”，具体设置需要看其规格文档。） PARAM_DATA_STR
	 *            :需要显示的数值字符串，只能显示8位：“0123456789.”。 PARAM_STATE_STR :设置“0 全暗”、“1
	 *            单价”、“2 总计”、“3 收款”、“4 找零”等显示。（具体设置需要看其规格文档。）
	 * @throws Exception
	 * @author Tyler Chen 新增日期：2008-10-17
	 * @author Tyler Chen 修改日期：2008-10-17
	 */

	public static void sendDisplay(Map<String, String> displayMap) throws Exception {
		...
		System.out.println(baudRate+",haha,"+displayRate);
	...
	/**
	 * 方法用途和描述:向顾客显示屏输出需要显示的数值字符串 方法的实现逻辑描述：
	 * 
	 * @param os
	 *            顾客显示屏输出流
	 * @param data
	 *            需要显示的数值字符串，只能显示8位：“0123456789.”。
	 * @throws Exception
	 * @author Tyler Chen 新增日期：2008-10-17
	 * @author Tyler Chen 修改日期：2008-10-17
	 */
	...
	/**
	 * 方法用途和描述:设定串行口波特率，默认：2400 方法的实现逻辑描述：
	 * 
	 * @param os
	 *            顾客显示屏输出流
	 * @param rate
	 ...
	 * 
	 * @param portName
	 *            端口名称，Windows：COM1，Linux：ttyS0
	 * @param rate
	 *            设定串行口的波特率，具体需要看顾客显示屏规格文档
	 * @return
	 * @throws Exception
	 * @author Tyler Chen 新增日期：2008-10-17
	 * @author Tyler Chen 修改日期：2008-10-17
	 ...
	 *            :串行口波特率需要与顾客显示屏的波特设置对应，默认：0。
	 *            （如一些顾显波特率为“2400”对应设置位为“0”，“4800”对应设置位为
	 *            “1”，“9600”对应设置位为“2”，具体设置需要看其规格文档。）
	 * @param data
	 *            :需要显示的数值字符串，只能显示8位：“0123456789.”。
	 * @param state
	 *            :设置“0 全暗”、“1 单价”、“2 总计”、“3 收款”、“4 找零”等显示。（具体设置需要看其规格文档。）
	 * @throws Exception
	 * @author Tyler Chen 新增日期：2008-10-17
	 * @author Tyler Chen 修改日期：2008-10-17
	 */
...
//			clearDisplay(os);
			...
			JOptionPane.showMessageDialog(jf, "请配置正确的客显端口！");
